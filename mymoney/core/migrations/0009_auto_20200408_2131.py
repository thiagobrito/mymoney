# Generated by Django 3.0.5 on 2020-04-09 00:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='BRL', max_digits=14, verbose_name='value')),
                ('scheduled', models.BooleanField(default=False)),
                ('paid', models.BooleanField(default=False)),
                ('bank_account', models.CharField(choices=[('CAI', 'Caixa'), ('NUB', 'Nubank'), ('SAN', 'Santander'), ('BRD', 'Bradesco')], max_length=3, verbose_name='bank_account')),
            ],
            options={
        ...
        migrations.AlterField(
            model_name='earnings',
            name='origin',
            field=models.CharField(choices=[('UD', 'Udemy'), ('AG', 'AlgoMania'), ('SL', 'Salario')], max_length=2, verbose_name='Source'),
        ),
        migrations.AlterField(
            model_name='funds',
            name='category',
            field=models.CharField(choices=[('AM', 'AlgoMania'), ('SL', 'Salary'), ('UD', 'Udemy'), ('BO', 'Bonus'), ('OT', 'Others')], default='', max_length=4, verbose_name='category'),
        ),
    ]
