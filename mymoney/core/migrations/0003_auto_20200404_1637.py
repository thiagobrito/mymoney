...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0002_earnings_origin'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='earnings',
            options={'ordering': ['date', 'value'], 'verbose_name_plural': 'Earnings'},
        ),
        migrations.AddField(
            model_name='earnings',
            name='value_currency',
        ...
        migrations.AlterField(
            model_name='earnings',
            name='origin',
            field=models.CharField(choices=[('AG', 'AlgoMania'), ('SL', 'Salario'), ('UD', 'Udemy')], max_length=2, verbose_name='Source'),
        ),
        migrations.AlterField(
            model_name='earnings',
            name='value',
            field=djmoney.models.fields.MoneyField(decimal_places=2, max_digits=14, verbose_name='value'),
        ),
    ]
